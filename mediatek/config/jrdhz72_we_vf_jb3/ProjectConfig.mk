...
#zhao.li@tcl bug 478533 CUSTOM_HAL_FLASHLIGHT = constant_flashlight
...
CUSTOM_HAL_IMGSENSOR = hi257_yuv hi351_yuv hi253_yuv gc0329_yuv
...
CUSTOM_HAL_MAIN_IMGSENSOR = hi257_yuv hi351_yuv hi253_yuv gc0329_yuv
...
CUSTOM_KERNEL_ALSPS = tmd2772 stk3311
...
#zhao.li@tcl bug 478533 CUSTOM_KERNEL_FLASHLIGHT = constant_flashlight
...
CUSTOM_KERNEL_IMGSENSOR = hi257_yuv hi351_yuv hi253_yuv gc0329_yuv
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = hi257_yuv hi351_yuv hi253_yuv gc0329_yuv
...
CUSTOM_KERNEL_TOUCHPANEL = ft6306 msg2138a
...
CUSTOM_LK_LCM = ili9806_6572_dsi_vdo ili9806_6572_dsi_vdo_txd
...
# Modified by jinming.xiang for share sdcard(441122)
...
MTK_AUDIO_PROFILES=no  #FR445066 Change MTK_AUDIO_PROFILES to no by rifang.zhang.hz
...
#Modified By Henry.Song 2013/06/25 for PR 476871 begin
MTK_BAIDU_MAP_SUPPORT=no
#Modified By Henry.Song 2013/06/25 for PR 476871 end
...
# modify MTK_DATA_TRANSFER_APP by qixing.chen for PR476411
...
# FR443116 modified  by yongming.li for support  emmc otp 
...
# disable iSMS according to CR466792 by qixing.chen
MTK_ISMS_SUPPORT=no
...
#modify by yangzhong.gong for FR441020 begin
MTK_OOBE_APP=no
#modify by yangzhong.gong for FR441020 end
...
#PR 533878,548342 xueming.li begin
MTK_PHONE_NUMBER_GEODESCRIPTION=yes
#PR 533878,548342 xueming.li end
...
# modified by jinming.xiang for 460234
...
# 20130607 modified by wangxingxing for EEM support
...
#modify by yangzhong.gong-001 for PR482048 begin
MTK_THEMEMANAGER_APP=no
#modify by yangzhong.gong-001 for PR482048 end
MTK_TINY_UTIL=yes
MTK_TLR_SUPPORT=no
...
#Modified by jinming.xiang for FR 442297 begin
MTK_YAML_SCATTER_FILE_SUPPORT=yes
#MTK_YAML_SCATTER_FILE_SUPPORT = no
#Modified by jinming.xiang for FR 442297 end
...
CUSTOM_MODEM=jrdhz72_we_vf_jb3_hspa
...
#modify by xiaoqin.zhou for PR515243 begin
# enable Video telephony
MTK_VT3G324M_SUPPORT=no
#modify by xiaoqin.zhou for PR515243 end
...
CUSTOM_KERNEL_LCM = ili9806_6572_dsi_vdo ili9806_6572_dsi_vdo_txd

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM = ili9806_6572_dsi_vdo ili9806_6572_dsi_vdo_txd
...
MTK_VIBSPK_SUPPORT = yes
#add project switch for yarism & yaris by wwl
HZ_YARISM_SUPPORT = yes
