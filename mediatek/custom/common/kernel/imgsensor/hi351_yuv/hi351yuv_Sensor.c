...
static kal_uint8 iso_speed = AE_ISO_AUTO;
...
else
{
 //Ewelly
      HI351_write_cmos_sensor(0x03, 0x11);
      HI351_write_cmos_sensor(0xf0, 0x80); // STEVE Dark mode for Sawtooth
}
...
BOOL HI351_set_param_exposure(UINT16 para)
{
	...
	printk("hujl@debug:enter %s, para=%d\n", __func__, para);
 /*modify by jinlin.HU for yarisM-vf*/ 
  HI351_write_cmos_sensor(0x03,0x10);
...
/*Add by Jinlin.Hu for yarisM-vf*/
void HI351_set_iso(UINT16 para)
{
	SENSORDB("[HI351]:HI351_set_iso func:para = %d\n",para);
	...
	switch (para) {
		...
		case AE_ISO_200:
			...
			//ISO 200
			HI351_write_cmos_sensor(0x03, 0x20);
			HI351_write_cmos_sensor(0x51, 0x58);
			HI351_write_cmos_sensor(0x52, 0x39);
			HI351_write_cmos_sensor(0x03, 0xc4);
			HI351_write_cmos_sensor(0x19, 0x39);
			HI351_write_cmos_sensor(0x1a, 0x39);
			HI351_write_cmos_sensor(0x1b, 0x39);
		...
		case AE_ISO_400:
			...
			//ISO 400
			HI351_write_cmos_sensor(0x03, 0x20);
			HI351_write_cmos_sensor(0x51, 0x80);
			HI351_write_cmos_sensor(0x52, 0x59);
			HI351_write_cmos_sensor(0x03, 0xc4);
			HI351_write_cmos_sensor(0x19, 0x59);
			HI351_write_cmos_sensor(0x1a, 0x59);
			HI351_write_cmos_sensor(0x1b, 0x59);
		...
		case AE_ISO_800:
			...
			//iso800
			HI351_write_cmos_sensor(0x03, 0x20);
			HI351_write_cmos_sensor(0x51, 0xc0); //Max Gain
			HI351_write_cmos_sensor(0x52, 0x69); //Min Gain
			HI351_write_cmos_sensor(0x03, 0xc4);
			HI351_write_cmos_sensor(0x19, 0x69); //Bnd0 Gain
			HI351_write_cmos_sensor(0x1a, 0x69); //Bnd1 Gain
			HI351_write_cmos_sensor(0x1b, 0x69); //Bnd2 Gain
			//AE On
			HI351_write_cmos_sensor(0x03, 0xc4);
			HI351_write_cmos_sensor(0x10, 0xa9);
		...
		case AE_ISO_AUTO:
			...
			//ISO AUTO
			HI351_write_cmos_sensor(0x03, 0x20);
			HI351_write_cmos_sensor(0x51, 0xa0);
			HI351_write_cmos_sensor(0x52, 0x28);
			HI351_write_cmos_sensor(0x03, 0xc4);
			HI351_write_cmos_sensor(0x19, 0x4a);
			HI351_write_cmos_sensor(0x1a, 0x54);
			HI351_write_cmos_sensor(0x1b, 0x5c);
...
/*Add by jinlin.Hu for yaris_m_vf(simba)*/
UINT32 HI351YUVGetExifInfo(UINT32 exifAddr)
{
	SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
	pExifInfo->AEISOSpeed = iso_speed;
	pExifInfo->RealISOValue = iso_speed;

	printk("hujl@debug:iso_speed = %d\n", iso_speed);
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	*pFeatureParaLen=4;
	...
	case SENSOR_FEATURE_GET_EXIF_INFO:
		HI351YUVGetExifInfo(*pFeatureData32);
		break;
