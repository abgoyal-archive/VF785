...
# Set PHONY
# *************************************************************************
#Modified By Henry.Song 2013/04/23
.PHONY : new newall remake remakeall clean cleanall \
         ...
         update-api modem-info bindergen clean-modem perso
...
#FR443144 added by yongming.li for show version begin
#
PRJDEF :=  yarism
# FR443144 added by yongming.li for change version  path
#VERSIONDEF := version_$(PRJDEF)/version.inc
VERSIONDEF := development/version/include/version.inc
VERSIONLEN := 12
#FR443144 added by yongming.li for show version end 
...
# ----------------------------------------------------------------
#    modified by jinming.xiang for FR:442297
# ----------------------------------------------------------------
...
# TODO: newall: cleanall remakeall update-api remakeall:
## add update-api for new and remake by jianbo.deng for PR483588 2013-07-08 begin
##newall: cleanall pregen update-api remakeall
newall: cleanall pregen remakeall
## PR483588 2013-07-08 end
...
ANDROID_NATIVE_TARGETS := \
         ...
         factoryimage userdataimage userdataimage-nodeps customimage ramdisk
...
ifeq ($(MTK_DEPENDENCY_AUTO_CHECK), true)
	...
	$(hide) cp -f $(SCATTER_FILE) $(LOGDIR)/$(PROJECT)
  ifeq ($(strip $(MTK_EMMC_SUPPORT)),yes)
...
#FR443123 added by yongming.li for root check 
ifeq ($(ACTION), )
	$(hide) /usr/bin/perl mediatek/build/tools/jrd_magic.pl $(PROJECT)
#	$(hide) /usr/bin/perl mediatek/build/tools/version.pl $(PROJECT)
endif
endif
jrdmagic:
	/usr/bin/perl mediatek/build/tools/jrd_magic.pl $(PROJECT)
#version:
#	/usr/bin/perl mediatek/build/tools/version.pl $(PROJECT)
