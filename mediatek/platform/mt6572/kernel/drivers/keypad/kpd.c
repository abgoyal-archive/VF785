...
/*long press reboot function realize*/
	if(kpd_enable_lprst && get_boot_mode() == NORMAL_BOOT) {
        ...
        /*susheng.ye add for FR449716 20130506 begin*/		
	...
	#endif
        #endif
        /*susheng.ye add for FR449716 20130506 end*/
        /*susheng.ye add for FR449716 20130711 begin*/		
	#ifndef TARGET_BUILD_MMITEST	
        /*wangxingxing add for FR436957 20130611 start*/
		 #ifdef KPD_PMIC_LPRST_TD               
		 kpd_print("Enable LPRST\n");                
		 upmu_set_rg_pwrkey_rst_en(0x01);
		 upmu_set_rg_homekey_rst_en(0x00);//sunjiaojiao modify for enable force power off without homekey                
		 upmu_set_rg_pwrkey_rst_td(KPD_PMIC_LPRST_TD); 
		 #endif
        /*wangxingxing sdd for FR436957 20130611end*/
        #endif
        /*susheng.ye add for FR449716 20130711 end*/
