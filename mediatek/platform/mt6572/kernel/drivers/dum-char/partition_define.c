...
struct excel_info PartInfo[PART_NUM]={
			...
			{"sec_ro",262144,0x3980000, EMMC, 0,USER},
			{"misc",524288,0x39c0000, EMMC, 0,USER},
			{"logo",3145728,0x3a40000, EMMC, 0,USER},
			{"ebr2",524288,0x3d40000, EMMC, 0,USER},
			{"custpack",642777088,0x3dc0000, EMMC, 4,USER},
			{"mobile_info",8388608,0x2a2c0000, EMMC, 5,USER},
			{"expdb",10485760,0x2aac0000, EMMC, 0,USER},
			{"android",681574400,0x2b4c0000, EMMC, 6,USER},
			{"cache",394264576,0x53ec0000, EMMC, 7,USER},
			{"usrdata",1073741824,0x6b6c0000, EMMC, 8,USER},
